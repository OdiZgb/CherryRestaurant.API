...
public class addRefundToBillCommandHandler : IRequestHandler<addRefundToBillCommand, BillDTO>
{
    private readonly AppDbContext _dbContext;
    private readonly IMapper _mapper;
    private readonly IMediator _mediator;

    public addRefundToBillCommandHandler(AppDbContext dbContext, IMediator mediator, IMapper mapper)
    {
...
public async Task<BillDTO> Handle(addRefundToBillCommand request, CancellationToken cancellationToken)
{
    Bill bill = new Bill();
